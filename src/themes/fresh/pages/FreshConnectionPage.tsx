...
const PLATFORM_GUIDES = {
  ios: {
    ...
    recommendedDesc: 'Современный клиент с мгновенным импортом подписки и умной маршрутизацией.',
    appStoreUrl: 'https://apps.apple.com/app/happ-proxy-utility/id6504287215',
    altApp: 'Streisand',
    altDesc: 'Альтернативный клиент для iPhone и iPad.',
    altUrl: 'https://apps.apple.com/app/streisand/id6450534064',
  },
  android: {
    id: 'android',
    title: 'Android',
    icon: Smartphone,
    recommendedApp: 'Happ (Рекомендуется)',
    recommendedDesc: 'Максимальная скорость, отсутствие рекламы и добавление подписки в 1 клик.',
    ...
    altApp: 'v2rayNG',
    altDesc: 'Классический проверенный клиент для Android.',
    altUrl: 'https://github.com/2dust/v2rayNG/releases/latest',
  },
  windows: {
    id: 'windows',
    title: 'Windows',
    ...
    recommendedDesc: 'Быстрый запуск в системном трее и авто-обновление рабочих серверов.',
    appStoreUrl: 'https://github.com/happ-proxy/happ-windows/releases/latest',
    altApp: 'v2rayN',
    altDesc: 'Функциональный клиент для продвинутых пользователей.',
    altUrl: 'https://github.com/2dust/v2rayN/releases/latest',
  },
  macos: {
    id: 'macos',
    title: 'macOS',
    ...
    appStoreUrl: 'https://apps.apple.com/app/happ-proxy-utility/id6504287215',
    altApp: 'Streisand',
    altDesc: 'Легковесный клиент для macOS.',
    altUrl: 'https://apps.apple.com/app/streisand/id6450534064',
  },
  tv: {
    id: 'tv',
    title: 'Android TV',
    icon: Tv,
    recommendedApp: 'Happ TV & v2rayNG',
    recommendedDesc: 'Специальная версия для пульта телевизора и ТВ-приставок.',
    appStoreUrl: 'https://play.google.com/store/apps/details?id=com.happproxy',
    altApp: 'Установка APK',
    altDesc: 'Прямая установка через флешку или Downloader.',
    altUrl: 'https://github.com/happ-proxy/happ-android/releases/latest',
  },
};
