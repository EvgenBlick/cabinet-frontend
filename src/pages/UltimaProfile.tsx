      ...
      <div className="mx-auto flex max-w-[540px] flex-col gap-3.5">
        ...
        >
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div className="flex aspect-square h-12 w-12 shrink-0 items-center justify-center rounded-full border-2 border-[#b89358]/50 bg-gradient-to-br from-[#d4b37f] to-[#a88247] shadow-[0_0_16px_rgba(212,179,127,0.3)]">
              <span className="text-[18px] font-extrabold text-[#0a0c0f]">{displayInitial}</span>
            </div>

            {/* Names & Handle */}
            <div className="min-w-0 flex-1">
              <h1 className="text-[18px] font-bold leading-tight text-[#f5f5f7] drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
                {displayName}
              </h1>
              <p className="mt-0.5 text-[13px] font-medium text-[#8e929b]">{accountHandle}</p>
            </div>
          ...
          <div className="mt-5 grid grid-cols-3 divide-x divide-white/[0.07] border-y border-white/[0.07] py-3.5">
            ...
            <div className="pr-2">
              ...
              <p className="mt-1 text-[15px] font-bold text-[#f5f5f7]">{balanceLabel}</p>
            </div>
            ...
            <div className="px-2">
              <div className="flex items-center gap-1 text-[#8e929b]">
                ...
                <span className="text-[9px] font-bold uppercase tracking-wider">Способы входа</span>
              </div>
            ...
            <div className="pl-2">
              ...
              <p className="mt-1 truncate text-[13px] font-bold text-[#f5f5f7]">
                {registeredAtLabel}
              </p>
            </div>
          </div>
          ...
          <button
            ...
            className="btn-gold-beam mt-4 w-full shadow-[0_8px_24px_rgba(212,179,127,0.35)] transition-all hover:brightness-110 active:scale-[0.98]"
          >
            <div
        ...
        {!isYandexLinked && (
          <div className="gold-animated-beam-wrapper shadow-[0_16px_36px_rgba(0,0,0,0.8)]">
            <div
              className="gold-animated-beam-content relative p-5"
              style={{
                background:
            ...
            >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <h2 className="text-[15px] font-bold text-[#f5f5f7]">
                    ...
                    <p className="mt-0.5 text-[11px] text-[#8e929b]">
                      Привяжите Яндекс, чтобы входить в личный кабинет на сайте без Telegram
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-3.5 space-y-2 rounded-xl border border-white/[0.06] bg-black/35 p-3 text-[12px]">
                <div className="flex items-center gap-2 text-[#f5f5f7]">
                  <span className="flex h-4 w-4 items-center justify-center rounded-full bg-[#d4b37f]/20 text-[10px] font-bold text-[#d4b37f]">
                    ✓
                  </span>
                  <span>Бесперебойный вход на сайте в любом браузере (на ПК и смартфонах)</span>
                </div>
                <div className="flex items-center gap-2 text-[#f5f5f7]">
                  <span className="flex h-4 w-4 items-center justify-center rounded-full bg-[#d4b37f]/20 text-[10px] font-bold text-[#d4b37f]">
                    ✓
                  </span>
                  <span>Защита подписки и настроек даже при сбоях или блокировках Telegram</span>
                </div>
              </div>
              ...
              <button
                ...
                className="btn-gold-beam mt-3.5 w-full shadow-[0_8px_24px_rgba(212,179,127,0.3)] transition-all hover:brightness-110 active:scale-[0.98]"
              >
                <div
                ...
                >
                  <span className="text-[14px] font-extrabold tracking-wide text-[#0a0c0f]">
                    Привязать Яндекс ID
                  </span>
        ...
        >
          <div>
            <h2 className="text-[15px] font-bold text-[#f5f5f7]">Аккаунт и безопасность</h2>
            <p className="mt-0.5 text-[11px] text-[#8e929b]">Устройства и способы входа</p>
          </div>
          ...
          <div className="mt-3 flex flex-col divide-y divide-white/[0.07]">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[14px] font-bold text-[#f5f5f7]">Подключённые устройства</p>
                  <p className="mt-0.5 text-[11px] text-[#8e929b]">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[14px] font-bold text-[#f5f5f7]">Способы входа</p>
                  <p className="mt-0.5 text-[11px] text-[#8e929b]">
        ...
        >
          <div>
            <h2 className="text-[15px] font-bold text-[#f5f5f7]">Бонусы и возможности</h2>
            <p className="mt-0.5 text-[11px] text-[#8e929b]">Приглашения, промокоды и подарки</p>
          </div>
          ...
          <div className="mt-3 flex flex-col divide-y divide-white/[0.07]">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[14px] font-bold text-[#f5f5f7]">Реферальная программа</p>
                  <p className="mt-0.5 text-[11px] text-[#8e929b]">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[14px] font-bold text-[#f5f5f7]">Промокод</p>
                  <p className="mt-0.5 text-[11px] text-[#8e929b]">Активация бонусов и скидок</p>
                </div>
              </div>
              <ChevronRight className="h-4 w-4 text-[#8e929b]" />
            </button>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[14px] font-bold text-[#f5f5f7]">Подарить</p>
                  <p className="mt-0.5 text-[11px] text-[#8e929b]">Создание подарочной подписки</p>
                </div>
              </div>
              <ChevronRight className="h-4 w-4 text-[#8e929b]" />
            </button>
        ...
        {/* 4. Action Buttons Footer: Copy ID & Logout */}
        <div className="grid grid-cols-2 gap-2.5 pt-1">
          <button
            type="button"
            onClick={handleCopyUserId}
            className="flex min-h-[46px] items-center justify-center gap-2 rounded-2xl border border-white/[0.1] bg-white/[0.03] px-3 py-2 text-[13px] font-semibold text-[#f5f5f7] backdrop-blur-md transition-colors hover:bg-white/[0.06] active:scale-95"
          >
          ...
          <button
            ...
            className="flex min-h-[46px] items-center justify-center gap-2 rounded-2xl border border-rose-500/25 bg-rose-500/10 px-3 py-2 text-[13px] font-semibold text-rose-300 backdrop-blur-md transition-colors hover:bg-rose-500/15 active:scale-95"
          >
