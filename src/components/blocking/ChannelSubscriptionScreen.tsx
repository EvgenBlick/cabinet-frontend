  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-dark-950 p-6">
      <div className="w-full max-w-md text-center">
        {/* Icon */}
        <div className="mb-8">
          <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-[#d4b37f]/20 to-[#b89358]/20">
            <svg className="h-12 w-12 text-[#d4b37f]" fill="currentColor" viewBox="0 0 24 24">
              ...
              >
                ...
                {ch.channel_link && (
                  <button
                    ...
                    className="rounded-lg bg-[#d4b37f]/20 px-3 py-1 text-xs font-medium text-[#d4b37f] hover:bg-[#d4b37f]/30"
                  >
        ...
        {channels.length === 0 && channelInfo?.channel_link && (
          <button
            ...
            className="mb-6 flex w-full items-center justify-center gap-3 rounded-xl bg-gradient-to-r from-[#d4b37f] to-[#b89358] px-6 py-4 font-semibold text-[#0a0c0f] transition-all duration-200 hover:brightness-110"
          >
            {t('blocking.channel.openChannel')}
          </button>
        )}
